...
<div className="container">            
  <div className="content">
    <div className="inner-wrapper">
      <div className="top-title">Oh!</div>
      <div className="main-title">
        4
        <span className="svg-wrap">
          <svg width="80px" height="80px" viewBox="0 0 40 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
              ...
              <g id="Lego-head" sketch:type="MSLayerGroup" transform="translate(1.000000, 1.000000)">
                <g id="Lego">
                  <g id="404-Page">
                    <g id="Group">
                      <g id="Lego-head">
                        <rect id="head-bottom" stroke="#D8B140" strokeWidth="2" fill="#F4CD3B" sketch:type="MSShapeGroup" x="9" y="29" width="20" height="11" rx="2"></rect>
                        <rect id="head-top" stroke="#D8B140" strokeWidth="2" fill="#F4CD3B" sketch:type="MSShapeGroup" x="11" y="0" width="16" height="11" rx="2"></rect>
                        <rect id="head" stroke="#D8B140" strokeWidth="2" fill="#F4CD3B" sketch:type="MSShapeGroup" x="0" y="4" width="38" height="32" rx="8"></rect>
